...
const premiumTiers: PremiumTier[] = [
  ...
  },
  {
    ...
    duration: "Levenslang Premium",
    description: "De ultieme ervaring! Voor altijd onbeperkt toegang tot alle huidige en toekomstige premium features. Eenmalige betaling, tijdelijke aanbieding!",
